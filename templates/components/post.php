...
<article class="post container" data-id="<?=$post["postID"]?>">
    ...
    <section id="post-title">
        <a href="post.php?id=<?=$post["postID"]?>"><h1><?=$post["title"]?></h1></a>
    </section>
    ...
    <section id="post-info">
        ...
        <a id="nrCommentsLink" href="post.php?id=<?=$post["postID"]?>">
        ...
        <div id="postByTimeAgo">
            <p id="postBy">
                Posted by
                <a id="postByLink" href="profile.php?user=<?=$post["userID"]?>"><?=$post["userID"]?></a>
                &minus;
